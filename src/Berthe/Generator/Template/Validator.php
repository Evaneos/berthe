<?php
class Evaneos_Berthe_Generator_Template_Validator extends Evaneos_Berthe_Generator_Template_Abstract {
    const CLASSNAME = "Validator";
    
    protected static $_instance = null;
    /**
     *
     * @return Evaneos_Berthe_Generator_Template_Validator
     */
    ...
    protected function _loadSignature(Zend_CodeGenerator_Php_Class $zcg) {
        $zcg->setImplementedInterfaces(array("Evaneos_Berthe_Validator"));
